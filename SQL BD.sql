...
INSERT INTO Usuarios (nombre_usuario, correo, contrasena) VALUES ('jose.gonzalez', 'jose.gonzalez@gmail.com', 'password1');
INSERT INTO Usuarios (nombre_usuario, correo, contrasena) VALUES ('maria.perez', 'maria.perez@gmail.com', 'password2');
INSERT INTO Usuarios (nombre_usuario, correo, contrasena) VALUES ('juan.rodriguez', 'juan.rodriguez@gmail.com', 'password3');
INSERT INTO Usuarios (nombre_usuario, correo, contrasena) VALUES ('ana.sanchez', 'ana.sanchez@gmail.com', 'password4');
INSERT INTO Usuarios (nombre_usuario, correo, contrasena) VALUES ('carlos.lopez', 'carlos.lopez@gmail.com', 'password5');

INSERT INTO Recetas (titulo, tipo_de_cocina, ingredientes, pais_de_origen, dificultad, instrucciones, tiempo_de_coccion, imagen_url) 
VALUES (
    'Cazuela de Vacuno',
    'Comida Chilena',
...
ALTER TABLE Recetas ADD ingredientes_temp VARCHAR2(4000);
UPDATE Recetas SET ingredientes_temp = ingredientes;
ALTER TABLE Recetas DROP COLUMN ingredientes;
ALTER TABLE Recetas RENAME COLUMN ingredientes_temp TO ingredientes;
ALTER TABLE Recetas ADD descripcion VARCHAR2(1000);

UPDATE Recetas
SET descripcion = 'Un reconfortante guiso chileno con carne y verduras, perfecto para días fríos.' WHERE titulo = 'Cazuela de Vacuno';

UPDATE Recetas
SET descripcion = 'Empanadas tradicionales rellenas de carne, cebolla y especias, horneadas hasta dorar.' WHERE titulo = 'Empanadas de Pino';

UPDATE Recetas
SET descripcion = 'Un hot dog chileno con tomate, mayonesa y palta, ideal para una comida rápida.' WHERE titulo = 'Completo Italiano';

UPDATE Recetas
SET descripcion = 'Papas fritas cubiertas con carne, cebolla y huevos, una combinación perfecta para compartir.' WHERE titulo = 'Chorrillana';

UPDATE Recetas
SET descripcion = 'Postre refrescante de mote y duraznos en almíbar, popular en verano.' WHERE titulo = 'Mote con Huesillos';

UPDATE Recetas
SET descripcion = 'Masa frita acompañada de pebre, un aperitivo típico chileno.' WHERE titulo = 'Sopaipillas con Pebre';

UPDATE Recetas
SET descripcion = 'Sopa de mariscos chilenos, ideal para amantes de los frutos del mar.' WHERE titulo = 'Paila Marina';

UPDATE Recetas
SET descripcion = 'Cóctel tradicional chileno a base de pisco, limón y un toque de amargo.' WHERE titulo = 'Pisco Sour';

UPDATE Recetas
SET descripcion = 'Pasta de choclo envuelta en hojas de maíz, cocinada al vapor.' WHERE titulo = 'Humitas';

UPDATE Recetas
SET descripcion = 'Tarta de manzana chilena, dulce y aromática, perfecta para el té.' WHERE titulo = 'Kuchen de Manzana';

UPDATE Recetas
SET descripcion = 'Un plato abundante de carnes y mariscos cocidos lentamente en una olla.' WHERE titulo = 'Curanto en Olla';

UPDATE Recetas
SET instrucciones = REPLACE(REPLACE(instrucciones, '\n', ' '), '1.', '1-')
WHERE titulo = 'Cazuela de Vacuno';

UPDATE Recetas
SET instrucciones = REPLACE(REPLACE(instrucciones, '\n', ' '), '1.', '1-')
WHERE titulo = 'Empanadas de Pino';

UPDATE Recetas
SET instrucciones = REPLACE(REPLACE(instrucciones, '\n', ' '), '1.', '1-')
WHERE titulo = 'Completo Italiano';

UPDATE Recetas
SET instrucciones = REPLACE(REPLACE(instrucciones, '\n', ' '), '1.', '1-')
WHERE titulo = 'Chorrillana';

UPDATE Recetas
SET instrucciones = REPLACE(REPLACE(instrucciones, '\n', ' '), '1.', '1-')
WHERE titulo = 'Mote con Huesillos';

UPDATE Recetas
SET instrucciones = REPLACE(REPLACE(instrucciones, '\n', ' '), '1.', '1-')
WHERE titulo = 'Sopaipillas con Pebre';

UPDATE Recetas
SET instrucciones = REPLACE(REPLACE(instrucciones, '\n', ' '), '1.', '1-')
WHERE titulo = 'Paila Marina';

UPDATE Recetas
SET instrucciones = REPLACE(REPLACE(instrucciones, '\n', ' '), '1.', '1-')
WHERE titulo = 'Pisco Sour';

UPDATE Recetas
SET instrucciones = REPLACE(REPLACE(instrucciones, '\n', ' '), '1.', '1-')
WHERE titulo = 'Humitas';

UPDATE Recetas
SET instrucciones = REPLACE(REPLACE(instrucciones, '\n', ' '), '1.', '1-')
WHERE titulo = 'Kuchen de Manzana';

UPDATE Recetas
SET instrucciones = REPLACE(REPLACE(instrucciones, '\n', ' '), '1.', '1-')
WHERE titulo = 'Curanto en Olla';

UPDATE Recetas
SET instrucciones = REPLACE(REPLACE(REPLACE(REPLACE(instrucciones, '2.', '2-'), '3.', '3-'), '4.', '4-'), '5.', '5-')
WHERE titulo = 'Cazuela de Vacuno';
...
ALTER TABLE Usuarios ADD roles VARCHAR2(25);

UPDATE usuarios
SET roles = 'admin' WHERE id = 1;
UPDATE usuarios
SET roles = 'admin' WHERE id = 2;
UPDATE usuarios
SET roles = 'usuario' WHERE id = 3;
UPDATE usuarios
SET roles = 'usuario' WHERE id = 4;
UPDATE usuarios
SET roles = 'usuario' WHERE id = 5;

UPDATE usuarios
SET contrasena = '$2a$12$Hg.lFDN4Inpy5II.ZnbSKeQNt6qE5x0J91XO8xsh7.m2eeSScbW/W' 
WHERE id = 1;
UPDATE usuarios
SET contrasena = '$2a$12$yv9oyZq4j1Aa0M61XtFNze.QllY4.jYFEafMj5HKHKUa8o39jgdwm' 
WHERE id = 2;
UPDATE usuarios
SET contrasena = '$2a$12$yM14B5EF5dIr.XgChAQwz.JEbQf2AxH2VgHxTkDQl6VbFtP4VX4V2' 
WHERE id = 3;
UPDATE usuarios
SET contrasena = '$2a$12$QwZAbpgvQMZzQaLx0lz5Z.BVu62ez9Uh7vi673wSp2svR3nyiG782' 
WHERE id = 4;
UPDATE usuarios
