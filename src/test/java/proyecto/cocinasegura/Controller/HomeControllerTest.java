...
public class HomeControllerTest {
        ...
        void testIndex() throws Exception {
                ...
                recetas.add(new Receta("Tarta de Manzana", "Postre", "Manzana, harina", "España", "Fácil",
                                "Instrucciones",
        ...
        void testBuscarRecetas() throws Exception {
                ...
                mockMvc.perform(get("/buscar").param("titulo", "Tarta"))
                                .andExpect(status().isOk())
                                .andExpect(view().name("resultados-buscar")) // Nombre de la vista actualizado
                                .andExpect(model().attribute("recetas", recetas));
        }
        ...
        void testMostrarRecetas() throws Exception {
                // Arrange
                List<Receta> recetas = new ArrayList<>();
                Receta receta = new Receta("Tarta de Manzana", "Postre", "Manzana, harina", "España", "Fácil",
                                "Instrucciones",
                                "30 min", null, null, "Deliciosa receta");
                recetas.add(receta);
                ...
                mockMvc.perform(get("/recetas").param("id", "1"))
                                .andExpect(status().isOk())
                                .andExpect(view().name("detalle-receta")) // Nombre de la vista actualizado
                                .andExpect(model().attribute("recetas", recetas))
